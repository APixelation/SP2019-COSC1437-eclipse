...
public class AWTCounter extends Frame implements ActionListener {
	...
	public AWTCounter () {
		...
		// the components from left-to-right, and flow to next row form top-to-bottom.
		
		lblCount = new Label("Counter");	// construct the Label component
		add(lblCount);						// "super" Frame container adds Label component
		
		tfCount = new TextField(count + "", 10);	// construct the TextField with initial text
		...
		setTitle("AWT Counter");	// "super" Frame set its title
